module GINIC::Node
  ...
  class FeatureExtraction
    include Base
    # @processing : 処理内容の番号 `GINIC::Processing::FeatureExtraction`
    ...
    def init_node(range)
      super
      self.processing = GINIC::Processing::FeatureExtraction.set
    end
    ...
    # - GINIC::Node::FeatureExtraction#execute では Float64 を返す
    #
    # *imgs* : PGM::Image の画像2つが格納された配列
    def execute(imgs)
      GINIC::Processing::FeatureExtraction.execute(processing, imgs).not_nil!.to_f
    end
